...
public class LockFreeList<T> implements ListAbstract<T>
{
    /**
     * First list node
     */
    ...
    public boolean add(T item) {
        System.out.println("LockFree adding "+item);
    ...
    public boolean remove(T item) {
        System.out.println("Lock Free removing "+item);
        int key = item.hashCode();
        boolean snip;
        while (true) {
            // find predecessor and curren entries
    ...
    public boolean contains(T item) {
        System.out.println("Lock Free checking "+item);
        int key = item.hashCode();
        // find predecessor and curren entries
        Window window = find(head, key);
        Node pred = window.pred, curr = window.curr;
